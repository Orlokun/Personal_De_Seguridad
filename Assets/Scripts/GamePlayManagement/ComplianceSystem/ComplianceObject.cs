...
namespace GamePlayManagement.ComplianceSystem
{
    public class ComplianceObject : IComplianceObject
    {
        ...
        {
            MComplianceObjectData = new ComplianceObjectData(complianceId, startDayId, endDayId, needsUnlock, motivationLvl, actionType, objectType, consideredParameter, complianceReqValues, toleranceValue, rewardValues, penaltyValues);
        }

...
{
    public class ComplianceRetainObject : ComplianceObject
    {
        public ComplianceRetainObject(int complianceId, DayBitId startDayId, DayBitId endDayId, bool needsUnlock, 

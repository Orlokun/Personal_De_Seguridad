...
namespace DataUnits.ItemScriptableObjects
{
    public class OtherItemBaseData : IOtherItemBaseData
    {
        ...
        public OtherItemBaseData(BitItemSupplier itemSupplier, int bitId, int mEffectiveness, int mDamage, int mRange, int mPersuasiveness,  ItemOrigin itemOrigin, List<ItemBaseRace> itemTypes, ItemBaseQuality itemBaseQuality)
        {

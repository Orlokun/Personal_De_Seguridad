...
{
    public class OtherItemBaseData : IOtherItemBaseData
    {
        ...
        public OtherItemBaseData(BitItemSupplier itemSupplier, int bitId, int mEffectiveness, int mDamage, int mRange, int mPersuasiveness,  ItemOrigin itemOrigin, List<ItemBaseType> itemTypes, ItemBaseQuality itemBaseQuality)
        {

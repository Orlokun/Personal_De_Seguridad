...
namespace InputManagement
{
    public interface IGeneralGameStateManager
    {
        ...
        event GeneralGamePlayStateManager.GameStateChangeHandler OnGameStateChange;
    }

    public class GeneralGamePlayStateManager : IGeneralGameStateManager
    {
        private static GeneralGamePlayStateManager _mInstance;
        public static GeneralGamePlayStateManager Instance
        {
            get
            {
                if (_mInstance == null)
                {
                    _mInstance = new GeneralGamePlayStateManager();
                }
                return _mInstance;
            }
        }
